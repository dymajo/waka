...
const Sponsor = () => (
  <View style={styles.wrapper}>
    ...
    <LinkedScroll>
      ...
      <Text style={paragraphStyles.p}>{t('sponsor.sponsorDescription')}</Text>
      <View style={styles.buttonRow}>
        <LinkButton href="mailto:hello@dymajo.com" label={t('sponsor.email')} />
      </View>
      <Text style={paragraphStyles.h1}>{t('sponsor.patreonTitle')}</Text>
      <Text style={paragraphStyles.p}>{t('sponsor.patreonDescription')}</Text>
      <View style={styles.buttonRow}>
      ...
      <View style={styles.buttonRow}>
        <LinkButton href="https://github.com/consindo/waka" label="GitHub" />
      </View>
